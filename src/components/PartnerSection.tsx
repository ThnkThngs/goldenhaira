      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
          ...
          <motion.div
            ...
            className="p-6 border border-border hover:border-primary/40 transition-all">
        ...
        <motion.div
          ...
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          className="p-8 border border-primary/20 bg-card mb-16">
        ...
        <motion.div
          ...
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          className="p-8 border border-primary/20 bg-card text-center">
          ...
          <div className="flex items-center justify-center gap-6">
            <a
              ...
              className="inline-flex items-center gap-2 border border-border text-sm text-foreground hover:border-primary/40 transition-colors py-3 px-4" href="tel:+60176662806">
            ...
            <a
              ...
              className="inline-flex items-center gap-2 py-3 px-4 bg-primary text-primary-foreground text-sm hover:bg-primary/90 transition-colors" href="https://wa.me/60176662806">
